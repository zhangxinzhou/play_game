...
class Portfolio:
    ...
    def calculate(self, line):
        ...
        for possible_return in self.frontier_y:
            ...
            self.result = minimize(self.minimize_volatility, init_guess, method='SLSQP', bounds=bounds,
                                   constraints=cons)
    ...
    def report(self):
        ...
        print("期望年化收益: {:.2f}%, 风险: {:.2f}%".format(self.best_results_arr[0] * 100, self.best_results_arr[1] * 100,
