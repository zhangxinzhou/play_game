...
def handle_skill():
    ...
    skill07_ok = img_position_match_color(img, skill07_xy, skill_ok_color)
    skill_xy_list = []
    if skill01_ok and not skill07_ok:
        # 点技能1
        skill_xy_list = [skill01_xy]
    elif skill01_ok and skill07_ok:
        # 点技能2,3,4,5,6,7,1
        skill_xy_list = [skill02_xy, skill03_xy, skill04_xy, skill05_xy, skill06_xy, skill07_xy, skill01_xy]
...
def hero_level_up():
    ...
    for hero_xy in hero_list:
        if img_position_match_color(get_img(), hero_xy, hero_ok_color):
